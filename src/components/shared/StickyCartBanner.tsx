            ...
            {cart.length > 0 && (
               ...
               >
                  <div className="max-w-md mx-auto pointer-events-auto">
                      <button 
                         onClick={onCheckout} 
                         className="w-full bg-primary text-white font-semibold py-4 rounded-full shadow-2xl flex justify-between px-8 items-center border border-white/40 shadow-primary/30"
                      >
